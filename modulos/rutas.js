...
var index = function(req, res)
{
    ...
    {
        user = req.user;
		var sql = "SELECT c.id, c.comentario,c.id_usuario, u.nombre, c.fecha FROM comentarios c INNER JOIN users u ON u.idusuario = c.id_usuario"; //CREAR SENTENCIA SQL EN ESTA VARIABLE...
		console.log(sql);
